                ...
                closeMenu();
    		 	...
    		 	switch(index){
    		 		...
    		 		case 3: gethtml5location_fun();
                            var url="navigator.php?langitude="+getCookie('langitude')+"&latitude="+getCookie('latitude');
                            delCookie('langitude');
                            delCookie('latitude');
                            Myframe.src=url;
    		 				document.getElementById("toast_loading").style.visibility = 'visible';
                			setTimeout(function(){document.getElementById("toast_loading").style.visibility = 'hidden'}, 1000);
    		 				break;
			...
			<div class="weui-tab" >
                ...
                <div class="weui-navbar__menu"  style="flex-grow:1;" onclick="getMenu()">
                        ...
                        <div id="menu" style="z-index:101;visibility: hidden;"  class="weui-navbar__menu-content">
                            ...
                            <div onclick="getmap()"  class="weui-cell">
                                    查看地图
                            </div>
