        ...
        <header>
            <br>
                <h3 class="weui-msg__title" style="vertical-align: middle;text-align:center;font-size:30px"><a>提交成功！</a></h3>
                 <h3 class="weui-msg__desc" style="vertical-align: middle;text-align:center;font-size:15px"><a>您现在可以通过点击被服预订查看<font color="red">查看刚才提交的信息。</font>如果提交有误请联系工作人员修改</a></h3>
            </header>
            <div class="weui-msg__opr-area">
            <p class="weui-btn-area">
                <a onclick="javascript:window.location.href='browseorderinfo.php?token=<?=$token?>'" class="weui-btn weui-btn_primary">查看预订单信息</a>
